                    ...
                    {page !== formTiles.length - 0 && (
                      <div className="flex py-[32px] px-[32px] justify-center">
                        <div className="grid grid-cols-1 gap-[60px] -mr-[24px] z-30 ">
                          ...
                          <div className="flex justify-end gap-[16px] items-center">
                            <h4 className="font-[500]">Lifestyle</h4>
                            <div
                              className={
                                page >= 1
                          ...
                          <div className="flex justify-end gap-[16px] items-center">
                            <h4 className="font-[500]">Tasks</h4>
                            <div
                              className={
                                page >= 3
                                  ? "w-[48px] h-[48px] rounded-full flex justify-center items-center bg-primary"
                          ...
                          <div className="flex justify-end gap-[16px] items-center">
                            <h4 className="font-[500]">Time management</h4>
                            <div
                              className={
                                page >= 4
                                  ? "w-[48px] h-[48px] rounded-full flex justify-center items-center bg-primary"
                          ...
                          <div className="flex justify-end gap-[16px] items-center">
                            <h4 className="font-[500]">Habits</h4>
                            <div
                              className={
                                page >= 5
                                  ? "w-[48px] h-[48px] rounded-full flex justify-center items-center bg-primary"
                  ...
                  <div className="md:p-[32px] pt-[20px] xl:w-[75%] lg:w-[60%]">
                    ...
                    {page === 1 && (
                      <div>
                        ...
                        <h4 className="md:text-[36px] md:font-[500]  md:leading-[44px] text-[24px] font-[600] leading-[32px] mt-[40px] md:mt-[0px]">
                          How well do you embrace a thriving mindset and
                          lifestyle?
                        </h4>
                    ...
                    {page === 2 && (
                      <div>
                        ...
                        <h4 className="md:text-[36px] md:font-[500]  md:leading-[44px] text-[24px] font-[600] leading-[32px] mt-[40px] md:mt-[0px]">
                          Assess your effectiveness in setting achievable goals.
                          Consider factors such as clarity, specificity, and
                    ...
                    {page === 3 && (
                      <div>
                        ...
                        <h4 className="md:text-[36px] md:font-[500]  md:leading-[44px] text-[24px] font-[600] leading-[32px] mt-[40px] md:mt-[0px]">
                          How well do you take proactive steps towards
                    ...
                    {page === 4 && (
                      <div>
                        ...
                        <h4 className="md:text-[36px] md:font-[500]  md:leading-[44px] text-[24px] font-[600] leading-[32px] mt-[40px] md:mt-[0px]">
                          Assess your proficiency in time management. Consider
                          factors such as prioritization, organization, and
                          utilization of time-saving techniques?
                        </h4>
                        <div className="mt-[44px] grid grid-cols-1 md:grid-cols-2 gap-[10px] sm:gap-[40px] md:gap-[10px]">
                          <div className="grid gap-[10px] sm:gap-[40px] md:gap-[10px]  grid-cols-5">
                            <div className="">
                    ...
                    {page === 5 && (
                      <div>
                        ...
                        <h4 className="md:text-[36px] md:font-[500]  md:leading-[44px] text-[24px] font-[600] leading-[32px] mt-[40px] md:mt-[0px]">
                          How well have you been able to identify the kind of
